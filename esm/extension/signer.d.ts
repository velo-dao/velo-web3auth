...
export declare class Web3AuthSigner implements OfflineAminoSigner, OfflineDirectSigner {
    #private;
    chain: Chain;
    constructor(chain: Chain, worker: Worker, clientPrivateKey: Buffer, workerPublicKey: Buffer, promptSign: PromptSign);
    getAccounts(): Promise<readonly AccountData[]>;
    signAmino(signerAddress: string, signDocument: StdSignDoc): Promise<AminoSignResponse>;
    signDirect(signerAddress: string, signDocument: SignDoc): Promise<DirectSignResponse>;
}
