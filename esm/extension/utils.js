...
export const decrypt = async (privateKey, { iv, ephemPublicKey, ciphertext, mac }) => await ecdecrypt(Buffer.from(privateKey), 
    ...
    const openloginAdapter = new OpenloginAdapter({
        ...
        adapterSettings: {
            ...
            whiteLabel: {
                ...
                useLogoLoader: true,
                logoDark: 'https://raw.githubusercontent.com/velo-dao/velo-branding/main/velo_logo.svg',
                logoLight: 'https://raw.githubusercontent.com/velo-dao/velo-branding/main/velo_logo.svg',
                mode: 'dark',
