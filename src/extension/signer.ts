import { type PromptSign, type SignData, type ToWorkerMessage } from "./types"
...
export class Web3AuthSigner implements OfflineAminoSigner, OfflineDirectSigner {
	chain: Chain
